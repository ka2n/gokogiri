...
import (
	"github.com/ka2n/gokogiri/html"
	"github.com/ka2n/gokogiri/xml"
)
...
found in the github.com/ka2n/gokogiri/xml package. The xml.StrictParsingOption is conveniently provided for standards-compliant
behaviour.
*/
